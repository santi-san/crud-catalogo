...
@section('contenido')
        ...
        <div class="alert bg-light border border-white shadow round col-8 mx-auto p-4">
            ...
            <form action="/modificarProducto" method="post" enctype="multipart/form-data">
                ...
                <br>
                Imagen actual: <br>
                <img src="/productos/{{ $Producto->prdImagen }}" class="img-thumbnail my-2" alt="">
                <br>
                ...
                <a href="/modificarProducto" class="btn btn-outline-secondary mb-3">Volver al panel de Productos</a>
            </form>
